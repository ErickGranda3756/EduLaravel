        ...
        <form method="POST" action="{{route('categories.update', $category)}}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check form-check-inline">
                    ...
                    <input class="form-check-input ml-2" type="radio" name='state' id="state" value="0"
                    {{($category->state==0)?'checked':''}}>
                </div>

                <div class="form-check form-check-inline">
                    <label class="form-check-label" for="">Público</label>
                    <input class="form-check-input ml-2" type="radio" name='state' id="state" value="1"
                    {{($category->state==1)?'checked':''}}>
                </div>
